...
| `--paper-mode`              | -     | `boolean` | `false`      | Enable academic paper mode for structured metadata extraction (title, authors, abstract, references)                                                                                                                 |
| `--paper-weights`           | -     | `string`  | -            | Path to custom zone classification weights JSON file for paper mode                                                                                                                                                  |
| `--paper-template-dir`      | -     | `string`  | -            | Path to custom journal template directory for paper mode                                                                                                                                                             |
| `--paper-review-dir`        | -     | `string`  | -            | Path to review queue output directory for low-confidence paper mode results                                                                                                                                          |
| `--paper-crf-model`         | -     | `string`  | -            | Path to trained CRF model file for paper mode zone classification                                                                                                                                                    |
