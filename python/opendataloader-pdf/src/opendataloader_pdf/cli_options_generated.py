...
CLI_OPTIONS: List[Dict[str, Any]] = [
    ...
    {
        "name": "paper-mode",
        "python_name": "paper_mode",
        "short_name": None,
        "type": "boolean",
        "required": False,
        "default": False,
        "description": "Enable academic paper mode for structured metadata extraction (title, authors, abstract, references)",
    },
    {
        "name": "paper-weights",
        "python_name": "paper_weights",
        "short_name": None,
        "type": "string",
        "required": False,
        "default": None,
        "description": "Path to custom zone classification weights JSON file for paper mode",
    },
    {
        "name": "paper-template-dir",
        "python_name": "paper_template_dir",
        "short_name": None,
        "type": "string",
        "required": False,
        "default": None,
        "description": "Path to custom journal template directory for paper mode",
    },
    {
        "name": "paper-review-dir",
        "python_name": "paper_review_dir",
        "short_name": None,
        "type": "string",
        "required": False,
        "default": None,
